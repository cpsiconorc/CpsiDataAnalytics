		...
		each(series.data, function (point) {
			...
			if (!graphic) { // Create the shapes
				point.graphic = renderer.path(shapeArgs).
					attr({
						fill: point.selected? options.states.select.color : point.color,
						stroke: point.selected? options.states.select.borderColor : options.borderColor,
